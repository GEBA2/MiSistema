...
<body >
	...
	<form action="modificarPartido.php" method="post" id="registro">
		...
		<tr>
			...
			<td><input type="text" name="dui" minlength="10" maxlength="10" onkeydown="return validarNumeros(event)" 
		...
		<tr>
			...
			<td><input type="text" name="representante" 
                    ...
                    class="required form-control"  required="true" onkeypress="return validarLetras(event)"></td>
		</tr>
		<tr>
